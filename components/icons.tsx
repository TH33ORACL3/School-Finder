...
// Fix: Define props as a type for better readability and to ensure components are correctly typed as React Components.
// This helps TypeScript understand that standard React props like 'key' can be passed without being part of the component's own props.
interface IconProps {
  className?: string;
}

interface FilledIconProps extends IconProps {
  filled?: boolean;
}
...
export const BookmarkIcon: React.FC<FilledIconProps> = ({ className = 'w-6 h-6', filled = false }) => (
...
export const StarIcon: React.FC<FilledIconProps> = ({ className = 'w-5 h-5', filled = false }) => (
...
export const HeartIcon: React.FC<FilledIconProps> = ({ className = 'w-6 h-6', filled = false }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill={filled ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
